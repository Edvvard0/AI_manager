...
async def create_message(chat_id: int, is_user: bool, content: str, session: AsyncSession = Depends(get_session)):
    await MessageDAO.add(session, chat_id=chat_id, is_user=is_user, content=content)
